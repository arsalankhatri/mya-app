...
const baseHref = "";
const deployUrl = "";
const projectRoot = "D:\\project_learning\\my-app";
...
module.exports = {
  ...
  "plugins": [  
    ...
    new SfdcDeployPlugin({
      credentialsPath: path.resolve(__dirname, 'credentials.js'),
      filesFolderPath : path.resolve(__dirname, 'dist'),
      staticResourceName : 'ModernSalesForce'         
  }),
  ],
  "node": {
    "fs": "empty",
